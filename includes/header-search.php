...
<div id="search-outer" class="nectar">
    <search id="search">
        <id class="container">
            ...
            <div id="close"><a id="close-link"  href="#" aria-labelledby="close-label"><span class="screen-reader-text"><?php echo esc_html__('Close Search','salient'); ?></span>
                    <?php
                    if ( 'material' === $theme_skin ) {
            ...
            <span id="close-label" class="screen-reader-text">Close the search box</span>
        </id><!--/container-->
    </search><!--/search-->
</div><!--/search-outer-->
